...
public class Ordliste {
	...
	public static void main(String[] args) {
		...
		// Sjekker om ordliste2 er undermengde av ordliste1
		if (ordListe1.undermengde(ordListe2)) {
			System.out.println("Ordliste2 er en undermengde av ordliste1");
		} else {
			System.out.println("Ordliste2 er ikke en undermengde av ordliste1");
		}
